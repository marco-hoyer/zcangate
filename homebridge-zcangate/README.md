...
| `RotationSpeed` (0–100%) | Slider is constrained (`minStep: 100/3`) to snap at 4 positions — 0%/33%/67%/100% — matching the unit's 4 speed levels, instead of a smooth 0–100 drag. Quantized to the nearest of 4 buckets and mapped to `ventilation_level_0`.._3`. Changing speed while in Auto mode first switches to Manual. |
